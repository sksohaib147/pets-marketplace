...
const catFoodProducts = [
  {
    id: 1,
    name: 'Whiskas Dry Cat Food 7KG',
    price: 22.99,
    image: 'https://images.unsplash.com/photo-1518715308788-3005759c61d4?auto=format&fit=crop&w=400&q=80',
    description: 'Crunchy dry food for adult cats. Rich in protein and vitamins.',
    sale: true,
    soldOut: false,
    rating: 4.7,
    reviews: 800,
  ...
  {
    id: 2,
    name: 'Me-O Tuna Cat Food 1.2KG',
    price: 18.99,
    image: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&fit=crop&w=400&q=80',
    description: 'Tuna-flavored dry food for cats. Supports healthy skin and coat.',
    sale: false,
    soldOut: false,
    rating: 4.6,
    reviews: 650,
  },
  {
    ...
    description: 'Special formula for kittens. Supports growth and immunity.',
    sale: true,
    soldOut: false,
    rating: 4.8,
    reviews: 900,
  },
  {
    ...
    description: 'Seafood-flavored dry food for adult cats. Irresistible taste.',
    sale: false,
    soldOut: false,
    rating: 4.5,
    reviews: 500,
  },
  {
    ...
    price: 24.99,
    image: 'https://images.unsplash.com/photo-1518715308788-3005759c61d4?auto=format&fit=crop&w=400&q=80',
    description: 'Convenient wet food trays for cats. No artificial flavors.',
    sale: true,
    soldOut: false,
    rating: 4.9,
    reviews: 320,
  },
  {
    ...
    price: 27.99,
    image: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&fit=crop&w=400&q=80',
    description: 'Formulated for indoor cats. Helps maintain healthy weight.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 410,
  ...
  {
    id: 7,
    name: 'Blue Buffalo Wilderness Chicken Recipe',
    price: 32.99,
    image: 'https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=400&q=80',
    description: 'Grain-free, high-protein dry food with real chicken for active cats.',
    sale: true,
    soldOut: false,
    rating: 4.8,
    reviews: 510,
  ...
  {
    id: 8,
    name: 'Iams ProActive Health Healthy Adult',
    price: 19.99,
    image: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=400&q=80',
    description: 'Chicken-flavored dry food for adult cats. Supports strong muscles.',
    sale: false,
    soldOut: false,
    rating: 4.6,
    reviews: 210,
  ...
  {
    id: 9,
    name: 'Fancy Feast Gravy Lovers Wet Cat Food',
    price: 21.99,
    image: 'https://images.unsplash.com/photo-1601758125946-6ec2ef64daf8?auto=format&fit=crop&w=400&q=80',
    description: 'Wet food with savory gravy. Variety pack for picky eaters.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 410,
  ...
  {
    id: 10,
    name: 'Purina ONE True Instinct Grain-Free',
    price: 28.99,
    image: 'https://images.unsplash.com/photo-1518715308788-3005759c61d4?auto=format&fit=crop&w=400&q=80',
    description: 'Grain-free dry food with real chicken. No fillers or artificial flavors.',
    sale: true,
    soldOut: false,
    rating: 4.9,
    reviews: 370,
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-6">
                  ...
                  {cat.name === 'Cat Food' && (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="font-medium group-hover:text-red-500 transition-colors text-red-500">{t.catFood}</span>
                      </div>
                    </Link>
                  )}
          ...
          <main className="flex-1">
            ...
            <h2 className="text-2xl font-bold mb-2 text-gray-800">Cat Food Products</h2>
            <p className="mb-6 text-gray-600 max-w-2xl">Explore our premium selection of cat food for kittens and adult cats. Choose from grain-free, high-protein, and wet or dry options to keep your feline healthy and happy.</p>
