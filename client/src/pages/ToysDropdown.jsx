...
const toyProducts = [
  {
    ...
    description: 'Durable rubber toy for dogs. Great for chewing and fetch games.',
    sale: true,
    soldOut: false,
    rating: 4.8,
    reviews: 1200,
  },
  {
    ...
    description: 'Simple, fun wire and cardboard toy for active cats.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 800,
  ...
  {
    id: 3,
    name: 'Kaytee Chew & Treat Toy for Rabbits',
    price: 5.99,
    image: 'https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=400&q=80',
    description: 'Safe wooden chew toy for rabbits and small pets.',
    sale: true,
    soldOut: false,
    rating: 4.6,
    reviews: 320,
  },
  {
    ...
    description: 'High-bounce rubber ball for dogs. Perfect for fetch.',
    sale: false,
    soldOut: false,
    rating: 4.9,
    reviews: 950,
  ...
  {
    id: 5,
    name: 'SmartyKat Skitter Critters Catnip Toys',
    price: 7.99,
    image: 'https://images.unsplash.com/photo-1601758125946-6ec2ef64daf8?auto=format&fit=crop&w=400&q=80',
    description: 'Catnip-filled plush mice for hours of feline fun.',
    sale: true,
    soldOut: false,
    rating: 4.8,
    reviews: 670,
  },
  {
    ...
    price: 19.99,
    image: 'https://images.unsplash.com/photo-1518715308788-3005759c61d4?auto=format&fit=crop&w=400&q=80',
    description: 'Interactive plush puzzle for dogs. Encourages problem-solving.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 540,
  },
  {
    ...
    description: 'Dispenses treats as cats play. Promotes healthy activity.',
    sale: false,
    soldOut: false,
    rating: 4.5,
    reviews: 410,
  ...
  {
    id: 8,
    name: 'Bunny Blast Yucca Chew Toy',
    price: 6.49,
    image: 'https://images.unsplash.com/photo-1507146426996-ef05306b0aed?auto=format&fit=crop&w=400&q=80',
    description: 'Natural chew toy for rabbits. Keeps teeth healthy and trim.',
    sale: true,
    soldOut: false,
    rating: 4.6,
    reviews: 210,
  },
  {
    ...
    price: 10.99,
    image: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&fit=crop&w=400&q=80',
    description: 'Flexible, durable ball for dogs. Great for tug and fetch.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 390,
  ...
  {
    id: 10,
    name: 'Ware Fun Tunnel for Small Pets',
    price: 13.99,
    image: 'https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=400&q=80',
    description: 'Collapsible tunnel for rabbits, guinea pigs, and ferrets. Encourages play.',
    sale: false,
    soldOut: false,
    rating: 4.8,
    reviews: 180,
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-6">
                  ...
                  {cat.name === 'Toys' && (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="font-medium group-hover:text-red-500 transition-colors text-red-500">{t.toys}</span>
                      </div>
                    </Link>
                  )}
          ...
          <main className="flex-1">
            ...
            <h2 className="text-2xl font-bold mb-2 text-gray-800">Pet Toys</h2>
            <p className="mb-6 text-gray-600 max-w-2xl">Keep your pets entertained and active with our collection of fun, safe, and durable toys. From chew toys and balls to interactive puzzles, we have something for every pet's playtime needs.</p>
