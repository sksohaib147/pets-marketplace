...
const beltsAndCagesProducts = [
  {
    ...
    description: 'Comfortable, adjustable harness for dogs. Ideal for daily walks.',
    sale: true,
    soldOut: false,
    rating: 4.8,
    reviews: 900,
  },
  {
    ...
    description: 'No-pull harness for better control on walks.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 700,
  ...
  {
    id: 3,
    name: 'Blueberry Pet Classic Nylon Dog Collar',
    price: 12.99,
    image: 'https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=400&q=80',
    description: 'Durable, adjustable collar in multiple colors and sizes.',
    sale: true,
    soldOut: false,
    rating: 4.6,
    reviews: 520,
  ...
  {
    id: 4,
    name: 'Rabbit Hutch Cage with Run',
    price: 89.99,
    image: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=400&q=80',
    description: 'Spacious outdoor cage for rabbits with weatherproof roof.',
    sale: false,
    soldOut: false,
    rating: 4.8,
    reviews: 210,
  ...
  {
    id: 5,
    name: 'MidWest Homes for Pets Dog Crate',
    price: 59.99,
    image: 'https://images.unsplash.com/photo-1601758125946-6ec2ef64daf8?auto=format&fit=crop&w=400&q=80',
    description: 'Foldable metal crate for dogs. Easy to set up and transport.',
    sale: true,
    soldOut: false,
    rating: 4.9,
    reviews: 1100,
  },
  {
    ...
    price: 39.99,
    image: 'https://images.unsplash.com/photo-1518715308788-3005759c61d4?auto=format&fit=crop&w=400&q=80',
    description: 'Secure, easy-access carrier for cats and small dogs.',
    sale: false,
    soldOut: false,
    rating: 4.7,
    reviews: 430,
  ...
  {
    id: 7,
    name: 'Rabbit Harness and Leash Set',
    price: 14.99,
    image: 'https://images.unsplash.com/photo-1558788353-f76d92427f16?auto=format&fit=crop&w=400&q=80',
    description: 'Soft, adjustable harness and leash for rabbits and small pets.',
    sale: false,
    soldOut: false,
    rating: 4.5,
    reviews: 120,
  },
  {
    ...
    description: 'Retractable leash for dogs up to 50 lbs. 16 ft length.',
    sale: true,
    soldOut: false,
    rating: 4.7,
    reviews: 510,
  ...
  {
    id: 9,
    name: 'Catit Cabrio Multi-Functional Cat Carrier',
    price: 54.99,
    image: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&fit=crop&w=400&q=80',
    description: 'Spacious, secure carrier for cats. Easy to clean and carry.',
    sale: false,
    soldOut: false,
    rating: 4.8,
    reviews: 210,
  ...
  {
    id: 10,
    name: 'MidWest Guinea Pig Habitat Cage',
    price: 49.99,
    image: 'https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=400&q=80',
    description: 'Large, easy-to-clean cage for guinea pigs and small pets.',
    sale: false,
    soldOut: false,
    rating: 4.6,
    reviews: 180,
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-6">
                  ...
                  {cat.name === 'Belts and Cages' && (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="font-medium group-hover:text-red-500 transition-colors text-red-500">{t.beltsAndCages}</span>
                      </div>
                    </Link>
                  )}
                </li>
          ...
          <main className="flex-1">
            ...
            <h2 className="text-2xl font-bold mb-2 text-gray-800">Belts, Harnesses, Collars, Cages & Carriers</h2>
            <p className="mb-6 text-gray-600 max-w-2xl">Find the perfect harness, collar, leash, or cage for your pet. Our collection includes safe, comfortable, and durable options for dogs, cats, rabbits, and small animals.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {beltsAndCagesProducts.map(product => (
